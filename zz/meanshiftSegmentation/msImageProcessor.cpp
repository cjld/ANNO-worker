...
void msImageProcessor::Filter(float sigmaS, float sigmaR, SpeedUpLevel speedUpLevel)
{
...
void msImageProcessor::Segment(float sigmaS, float sigmaR, int minRegion, SpeedUpLevel speedUpLevel)
{
